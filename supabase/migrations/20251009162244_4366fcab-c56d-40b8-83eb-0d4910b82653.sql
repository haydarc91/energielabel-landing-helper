...
-- Update contact_submissions RLS to use has_role function
...
-- Update website_content RLS to use has_role function
drop policy if exists "Authenticated users can manage website content" on public.website_content;
